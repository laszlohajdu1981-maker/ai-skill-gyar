...
## 📁 Tartalom (7 kész skill)

| # | Skill neve | Cél | Kulcs output |
|---|------------|-----|-------------|
| 1 | **Gyerekülés** | ISO kompatibilitás | `recommendation: Buy` [file:1] |
| 2 | **Webshop vélemény** | Pain points | `severity: high` [file:2] |
| 3 | **Foldable törésteszt** | Kijelző tartósság | `score: 5/10` [file:3] |
| 4 | **AR szemüveg** | Ár/érték | `Buy @ 8/10` [file:4] |
